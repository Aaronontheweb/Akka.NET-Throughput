...
namespace Akka.Remote.Tests.Performance
{
    ...
    public abstract class RemoteMessagingThroughputSpecBase
    {
        ...
        public void Setup(BenchmarkContext context)
        {
            ...
            var system1Address = System1.AsInstanceOf<ExtendedActorSystem>().Provider.AsInstanceOf<RemoteActorRefProvider>().Transport.DefaultAddress;
            var system2Address = System2.AsInstanceOf<ExtendedActorSystem>().Provider.AsInstanceOf<RemoteActorRefProvider>().Transport.DefaultAddress;
